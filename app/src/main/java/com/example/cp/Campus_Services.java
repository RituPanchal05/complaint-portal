...
public class Campus_Services extends AppCompatActivity {

    private static final String TAG = "Campus_Services";
    private static final String URL = "http://192.168.117.51/fatch.php?column=Campus_Services";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_campus_services);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Start the next activity
                 ...
                 Intent intent = new Intent(Campus_Services.this, Add_complaint2.class);
    ...
    private void fetchDataFromServer() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, URL, null,
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Campus_Services.this, "Failed to fetch data", Toast.LENGTH_SHORT).show();
