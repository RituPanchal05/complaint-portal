...
public class Facilities_Infrastructure extends AppCompatActivity {

    private static final String TAG = "Facilities_Infrastructure";
    private static final String URL = "http://192.168.117.51/fatch.php?column=Facilities_Infrastructure";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_facilities_infrastructure);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Change Add_complaint.class to your desired activity
                 Intent intent = new Intent(Facilities_Infrastructure.this, Add_complaint5.class);
    ...
    private void fetchDataFromServer() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, URL, null,
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Facilities_Infrastructure.this, "Failed to fetch data", Toast.LENGTH_SHORT).show();
