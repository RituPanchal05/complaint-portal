...
public class Academic_issue extends AppCompatActivity {

    private static final String TAG = "Academic_issue";
    private static final String URL = "http://192.168.117.51/fatch.php?column=Acadamic_complain";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_academic_issue);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Change Add_complaint.class to your desired activity
                 Intent intent = new Intent(Academic_issue.this, Add_complaint.class);
    ...
    private void fetchDataFromServer() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, URL, null,
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Academic_issue.this, "Failed to fetch data", Toast.LENGTH_SHORT).show();
