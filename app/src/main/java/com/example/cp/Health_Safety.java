...
public class Health_Safety extends AppCompatActivity {

    private static final String TAG = "Health_Safety";
    private static final String URL = "http://192.168.117.51/fatch.php?column=Health_Safety";
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Change Add_complaint.class to your desired activity
                 Intent intent = new Intent(Health_Safety.this, Add_complaint6.class);
    ...
    private void fetchDataFromServer() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, URL, null,
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Health_Safety.this, "Failed to fetch data", Toast.LENGTH_SHORT).show();
