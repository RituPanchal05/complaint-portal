...
public class Extracurricular_Activities extends AppCompatActivity {

    private static final String TAG = "Extracurricular_Activities";
    private static final String URL = "http://192.168.117.51/fatch.php?column=Extracurricular_Activities";
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Change Add_complaint.class to your desired activity
                 Intent intent = new Intent(Extracurricular_Activities.this, Add_complaint4.class);
    ...
    private void fetchDataFromServer() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, URL, null,
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Extracurricular_Activities.this, "Failed to fetch data", Toast.LENGTH_SHORT).show();
