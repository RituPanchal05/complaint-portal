...
public class Administrative_Issues extends AppCompatActivity {

    private static final String TAG = "Administrative_Issues";
    private static final String URL = "http://192.168.117.51/fatch.php?column=Administrative_Issues";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_administrative_issues);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Change Add_complaint.class to your desired activity
                 ...
                 Intent intent = new Intent(Administrative_Issues.this, Add_complaint1.class);
    ...
    private void fetchDataFromServer() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, URL, null,
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Administrative_Issues.this, "Failed to fetch data", Toast.LENGTH_SHORT).show();
